...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateQuery = "UPDATE items SET name='$name', description='$description', category='$category', price='$price', created_at='$created_at', updated_at='$updated_at', status='$status' WHERE id=$id";
