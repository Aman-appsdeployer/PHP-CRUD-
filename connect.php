...
$str = "INSERT INTO items VALUES ($a, '$b', '$c', '$d', '$e', '$f', '$g', '$h')";
...
echo "<br><br> <h1>Show Your Inserted Data<hr></h1><br>";
echo "<table border='1'>";
echo "<tr><th>ID</th><th>Name</th><th>Description</th><th>Category</th><th>Price</th><th>Created At</th><th>Updated At</th><th>Status</th></tr>";
